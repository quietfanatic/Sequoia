...
//     - If the value is a function, it will be added as an event listener on the element.
//     - If the value is an object, it can contain both options to addEventListener (passive,
//        capture, etc.) and a handleEvent method which is the handler.
//     - Anything else will be interpreted as a string an set as an attribute on the element.
//  - If there are any non-object arguments, the element's content will be cleared and
//      replaced with the arguments, which can be Nodes, stringish things, or arrays of Nodes
//      and stringish things.  To clear the content without replacing it with anything, use an
//      empty array.
